...
class AliExpressClient:
    def __init__(self) -> None:
        ...
        self.sync_url = "https://api-sg.aliexpress.com/sync"
    ...
    def _raise_sync_error(self, data: dict[str, Any]) -> None:
        ...
        if str(data.get("code", "0")) not in {"0", "200", "SUCCESS"} and data.get("message"):
            raise AliExpressError(f"AliExpress API error: {data.get('message')}")
